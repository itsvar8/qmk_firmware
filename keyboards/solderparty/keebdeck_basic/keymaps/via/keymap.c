...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        KC_LCTL, KC_LGUI, KC_LALT, KC_BSLS, KC_SPC,  KC_SPC, KC_SPC, KC_RALT, KC_LEFT, KC_DOWN, KC_RGHT, KC_RSFT
    ),
    [1] = LAYOUT(
        QK_BOOT, _______, _______, _______, _______, _______, _______, _______, KC_DEL,  KC_F11,  _______, _______,
